# Prompt 06: Urgent Agent Config Operator UX Docs Sync
...
```text
Prompt '06_urgent_agent_config_operator_ux_docs_sync_prompt.md'
...
2. Продолжай только если:
   - `allowed_next_step = 06_urgent_agent_config_operator_ux_docs_sync`;
