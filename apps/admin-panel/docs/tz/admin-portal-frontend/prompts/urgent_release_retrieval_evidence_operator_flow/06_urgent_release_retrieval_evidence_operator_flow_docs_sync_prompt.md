...
```text
Prompt '06_urgent_release_retrieval_evidence_operator_flow_docs_sync_prompt.md'
...
2. Продолжай только если:
   - `allowed_next_step = 06_urgent_release_retrieval_evidence_operator_flow_docs_sync`;
