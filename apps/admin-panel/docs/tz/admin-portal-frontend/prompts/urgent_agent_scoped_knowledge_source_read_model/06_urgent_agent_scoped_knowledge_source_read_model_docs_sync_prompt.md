# Prompt 06: Urgent Agent-Scoped Knowledge Source Read Model Docs Sync
...
```text
Prompt '06_urgent_agent_scoped_knowledge_source_read_model_docs_sync_prompt.md'
...
2. Продолжай только если:
   - `allowed_next_step = 06_urgent_agent_scoped_knowledge_source_read_model_docs_sync`;
