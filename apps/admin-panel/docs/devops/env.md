...
| --- | --- | --- | --- |
| `AI_ADMIN_DEV_API_TARGET` | local dev server | `http://127.0.0.1:8008` | Vite proxy target for `/api`. |
...
| `VITE_APP_VERSION` | browser runtime | `admin-panel-local` | Value sent in `x-app-version`. |
